...
************************************************************************
      ...
      INTEGER PARENT_ID, NUCGEN, EVNT, GEN
      ...
      CHARACTER*256 OUTDIR, PRODFILE, ESCFILE
      ...
      OUTDIR  = '/hdfs/store/user/ralharth/mucol-targetstudy/flukaSims/BfieldStrength/'
      PRODFILE = TRIM(OUTDIR) // TRIM(FILNAM) // '_prod.txt'
      ESCFILE = TRIM(OUTDIR) // TRIM(FILNAM) // '_esc.txt'
...
*     !&       (JSCRNG .EQ. 5) .OR. (JSCRNG .EQ. 6) ) ) THEN
     ...
     &        ATRACK, GEN+2, EVNT, JTRACK
      
      END IF
 7777 FORMAT (I6,9E15.7,3I7)
     ...
     &        ATRACK, GEN+1, EVNT, PARENT_ID
         END IF
         
         END IF
     
      END IF
 9899 FORMAT (I6,9E15.7,3I7)
